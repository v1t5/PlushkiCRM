...
use Plushki\Orders\Platform\ProblemException;

/**
 * Api collects the small HTTP helpers the controllers share. Request DTOs use
 * snake_case public properties so they map 1:1 to the JSON body.
 */
final class Api
{
    public const BASE = 'https://errors.plushki/orders/';
