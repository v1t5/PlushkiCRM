...
namespace Plushki\Notifications\Platform\Http;
...
use Plushki\Notifications\Platform\Problem;
use Plushki\Notifications\Platform\ProblemException;

/**
 * Renders every uncaught error as RFC 7807 problem+json. A ProblemException
 * carries an explicit Problem; framework 404/405 map to the common type URIs;
 * anything else becomes a 500 internal-error problem.
 */
