...
namespace Plushki\Inventory\Platform\Events;
...
/**
 * OutboxRelay drains outbox_events into a service's topic exchange on RabbitMQ.
 * Pull cadence is $intervalMs, batch size is $batchSize. On publish failure the
 * event stays unpublished and is retried on the next tick — consumers dedupe on
 * event_id at the DB layer, so redelivery is safe.
 *
