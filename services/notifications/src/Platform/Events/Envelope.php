...
namespace Plushki\Notifications\Platform\Events;

use OpenTelemetry\API\Trace\Span;
use Symfony\Component\Uid\Uuid;

/**
 * The JSON event envelope shared by every service (see docs/architecture.md →
 * Messaging):
 *
...
final class Envelope
{
    ...
    /**
     * Mints a new envelope for `schema`, capturing the current OTel trace_id so
     * the event correlates with the request that produced it.
     *
     * @param array<string, mixed> $data
     */
