...
/**
 * Emits one structured log line per HTTP request with status, duration and route.
 * trace_id/span_id are added by the Monolog formatter automatically (see Platform\Log).
 */
