...
/**
 * Otel wires the global OpenTelemetry tracer provider with an OTLP/HTTP
 * exporter pointed at Tempo's HTTP receiver ("http://tempo:4318", set via
 * APP_OTLP_ENDPOINT), avoiding the ext-grpc requirement.
 *
...
final class Otel
{
    ...
    {
        // Accept either a bare host:port (tempo:4317) or an http(s):// URL.
