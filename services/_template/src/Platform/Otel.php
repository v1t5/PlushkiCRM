 ...
 * exporter pointed at Tempo's OTLP HTTP receiver ("http://tempo:4318"), chosen
 * over gRPC to avoid the ext-grpc requirement.
 *
...
final class Otel
{
    ...
    {
        // Accept a bare host:port (tempo:4318) or http(s)://host:port.
