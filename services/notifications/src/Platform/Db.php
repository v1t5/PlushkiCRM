...
/**
 * Opens a Doctrine DBAL connection from a postgres:// DSN. DBAL is used purely
...
final class Db
{
    public static function open(string $dsn): Connection
    {
        ...
        // Ping once — DriverManager is lazy, so force a real connect to surface
    ...
    /**
     * Translate postgres://user:pass@host:5432/dbname?sslmode=disable into DBAL
     * connection params (driver pdo_pgsql), done by hand to stay robust across
     * DBAL versions.
     *
