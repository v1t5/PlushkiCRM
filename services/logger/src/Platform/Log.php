...
/**
 * Builds a JSON Monolog logger that writes to stdout with the standard fields
 * (svc, env) and decorates every line with trace_id / span_id from the active
 * OTel span, so Loki/Grafana queries are consistent across services.
 */
final class Log
{
