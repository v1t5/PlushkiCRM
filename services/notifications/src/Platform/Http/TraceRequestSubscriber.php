...
/**
 * Opens one server span per HTTP request, extracting an inbound W3C traceparent
 * so traces stitch across the gateway and other services. The active span lets
 * Platform\Log attach trace_id/span_id to every log line.
 */
