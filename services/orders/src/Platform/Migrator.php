 ...
 * second run is a no-op (pending up-migrations only).
 */
final class Migrator
{
    ...
    /**
     * Returns the SQL between `-- +goose Up` and `-- +goose Down`, with the
     * StatementBegin/End and comment markers stripped.
     */
