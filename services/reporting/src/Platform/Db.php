...
namespace Plushki\Reporting\Platform;
...
{
    /**
     * Opens a lazy DBAL connection and pings it once to surface bad
     * credentials / networking before the service finishes booting.
     */
