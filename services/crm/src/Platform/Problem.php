...
/**
 * Problem is an RFC 7807 application/problem+json response body. `type` is a
 * stable URI that frontends localise — never put human-readable text in fields
 * a client will display.
 */
final class Problem
{
