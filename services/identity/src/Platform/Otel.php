...
/**
 * Otel wires the global OpenTelemetry tracer provider with an OTLP/HTTP exporter
 * pointed at Tempo's OTLP HTTP receiver ("http://tempo:4318"), avoiding the
 * ext-grpc requirement.
 *
...
final class Otel
{
    ...
    {
        // Accept a bare host:port (e.g. tempo:4318) or a full http(s):// URL.
