...
/**
 * Resolved runtime configuration. Defaults come from the constructor; they are
 * overlaid first by an optional config.yaml (local pinning), then by APP_*
 * environment variables (12-factor deployments). Env wins.
 */
final class Config
{
    ...
    /**
     * Resolve config from defaults -> optional config.yaml -> APP_* env.
