...
/**
 * Consumer subscribes a durable queue to a topic exchange and dispatches each
 * message to a handler (used by inventory / production / crm / reporting /
 * notifications):
 *
 *   - durable, non-exclusive queue (name = the durable consumer name,
 *     e.g. reporting-orders-fulfilled),
 ...
 *
 * One container per consumer (`<svc>-consume-<src>`); the handler receives the
 * decoded Envelope.
 *
